...
// ThingSpeak
unsigned long myChannelNumber = 0;            // Your Channel ID (numbers only)
...
// Telegram
String botToken = "telegram_bot_token";           // From @BotFather
String chatID   = "telegram_chat_id";             // From @userinfobot
